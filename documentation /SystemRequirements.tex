...
\usepackage{float}
\usepackage{graphicx}
\graphicspath{ {./images/SystemRequirement} }
...
\begin{figure}[H]
    \centering
    \includegraphics[width = 15cm]{images/SystemRequirement/contextDiagram.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width = 15cm]{images/SystemRequirement/fd.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width = 15cm]{images/SystemRequirement/stateMachine.png}
